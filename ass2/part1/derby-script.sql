...
DROP TABLE OSP_AREA;
DROP TABLE OSP_VEHICLE_OPTIONS;
...
CREATE TABLE OSP_VEHICLE_OPTIONS(VEHICLE_OPT_ID BOOLEAN NOT NULL PRIMARY KEY, PRESENT VARCHAR(20));
...
CREATE TABLE OSP_PARKING(ID INT NOT NULL GENERATED ALWAYS AS IDENTITY
    ...
    VEHICLE_OPT_ID BOOLEAN REFERENCES OSP_VEHICLE_OPTIONS(VEHICLE_OPT_ID),
...
CALL SYSCS_UTIL.SYSCS_IMPORT_DATA (NULL, 'OSP_VEHICLE_OPTIONS', NULL, NULL, 'vehicle_present_options.csv', NULL, NULL, NULL, 0);
...
CALL SYSCS_UTIL.SYSCS_IMPORT_DATA (NULL, 'OSP_PARKING', 'DEVICE_ID,ARRIVE,DEPART,DURATION,STREET_MARKER,PARKING_SIGN,AREA_ID,STREET_ID,VEHICLE_OPT_ID,VIOLATION_OPT_ID', NULL, 'parking.csv', NULL, NULL, NULL, 0);
