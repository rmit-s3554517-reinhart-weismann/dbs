...
public interface dbimpl
{
   ...
   public static final int RECORD_SIZE = 321;
   ...
   public static final int DURATION_SIZE = 10;
   ...
   public static final int PRESENT_SIZE = 5;
   ...
   public static final int PRESENT_OFFSET = RID_SIZE
                                         + DEVICE_ID_SIZE
                                         + ARRIVAL_TIME_SIZE
                                         + DEPART_TIME_SIZE
                                         + DURATION_SIZE
